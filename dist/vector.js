...
var Vec = (exports.Vec = (function(_extendableBuiltin2) {
  ...
  function Vec(x, y, z) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Vec.__proto__ || Object.getPrototypeOf(Vec)).call(this)
    )

    _this.map = function(fn) {
      var thisArg =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _this

      return new Vec(
        _get(
          Vec.prototype.__proto__ || Object.getPrototypeOf(Vec.prototype),
          'map',
          _this
        ).call(_this, fn, thisArg)
      )
    }
    ...
    _this.reduce = function() {
      ...
      var res = (_get2 = _get(
        ...
        'reduce',
        _this
      )).call.apply(_get2, [_this].concat(args))
...
var Vector = (exports.Vector = function Vector() {
  for (
    var _len3 = arguments.length, dimensions = Array(_len3), _key3 = 0;
    _key3 < _len3;
    _key3++
  ) {
...
var argsOrArray = function argsOrArray() {
  for (
    var _len4 = arguments.length, vecs = Array(_len4), _key4 = 0;
    _key4 < _len4;
    _key4++
  ) {
...
var add = (exports.add = function add() {
  for (
    var _len5 = arguments.length, vecs = Array(_len5), _key5 = 0;
    _key5 < _len5;
    _key5++
  ) {
...
var sub = (exports.sub = function sub() {
  for (
    var _len6 = arguments.length, vecs = Array(_len6), _key6 = 0;
    _key6 < _len6;
    _key6++
  ) {
...
var mult = (exports.mult = function mult() {
  for (
    var _len7 = arguments.length, vecs = Array(_len7), _key7 = 0;
    _key7 < _len7;
    _key7++
  ) {
...
var div = (exports.div = function div() {
  for (
    var _len8 = arguments.length, vecs = Array(_len8), _key8 = 0;
    _key8 < _len8;
    _key8++
  ) {
...
var sum = (exports.sum = function sum() {
  for (
    var _len9 = arguments.length, vecs = Array(_len9), _key9 = 0;
    _key9 < _len9;
    _key9++
  ) {
...
var zip = function zip() {
  for (
    var _len10 = arguments.length, rows = Array(_len10), _key10 = 0;
    _key10 < _len10;
    _key10++
  ) {
    rows[_key10] = arguments[_key10]
  }
